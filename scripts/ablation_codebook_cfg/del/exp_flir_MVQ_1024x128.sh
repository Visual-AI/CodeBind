...
expname=flir_MVQ_1024x128  # K = 1024, dim = 128
...
--cfg_model config/cfg_ablation/cfg_model_ablation_MVQ_1024x128.yaml \
...
--device cuda:2 2>&1 | tee ./exp/${expdir}/${expname}/${timestamp}_train.log
