...
expname=flir_MVQ_4096x8  # K = 4096, dim = 8
...
--cfg_model config/cfg_ablation/cfg_model_ablation_all_4096x8.yaml \
...
--device cuda:4 2>&1 | tee ./exp/${expdir}/${expname}/${timestamp}_train.log
