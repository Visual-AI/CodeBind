...
expname=flir_all_256x8  # K = 256, dim = 8
...
--cfg_model config/cfg_ablation/cfg_model_ablation_all_256x8.yaml \
...
--device cuda:6 cuda:7 2>&1 | tee ./exp/${expdir}/${expname}/${timestamp}_train.log
